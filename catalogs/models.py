...
class Vehicle(models.Model):
    name = models.CharField(max_length=150, blank=False, null=False)
    registration_plate = models.CharField(max_length=15, blank=False, null=False)
    brand = models.ForeignKey(VehicleBrand, on_delete=models.PROTECT, blank=False, null=False, related_name="brands")
...
class Product(models.Model):
    ...
    vat_rate = models.ForeignKey(VATRate, on_delete=models.PROTECT, related_name='vatrates')
