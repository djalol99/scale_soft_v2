...
router.register(r'organizations', api_views.OrganizationViewSet, basename='organization')
router.register(r'warehouses', api_views.WarehouseViewSet, basename='warehouse')
router.register(r'counterparties', api_views.CounterpartyViewSet, basename='counterparty')
...
urlpatterns = [
    ...
    path("exchange/<str:object>/", api_views.ExchangeList.as_view(), name="brands-exchange"),
